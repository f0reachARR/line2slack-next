...
service SecondaryQrCodeLoginService {
    LoginQrCode_CreateQrSessionResponse createSession() throws (1: SecondaryQrCodeException e),
    ...
    void verifyCertificate(1: LoginQrCode_VerifyCertificateRequest request) throws (1:SecondaryQrCodeException e),
...
service LoginPermitNoticeService {
    void checkQrCodeVerified(1: LoginQrCode_CheckQrCodeVerifiedRequest request) throws (1:SecondaryQrCodeException e),
    void checkPinCodeVerified(1: LoginQrCode_CheckPinCodeVerifiedRequest request) throws (1:SecondaryQrCodeException e),
}
