...
declare class Client {
    ...
    getMoretabRecommend(): Promise<MoretabRecommend>;

    getMoretabRecommend(callback?: (error: ttypes.TalkException, response: MoretabRecommend)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getMoretabRecommend(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
