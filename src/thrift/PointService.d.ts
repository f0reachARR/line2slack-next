...
declare class Client {
    ...
    getBalance(request: GetBalanceRequest, callback?: (error: ttypes.PointException, response: GetBalanceResponse)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBalance(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
