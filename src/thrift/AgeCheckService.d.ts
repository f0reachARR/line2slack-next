...
declare class Client {
    ...
    checkUserAge(carrier: CarrierCode, sessionId: string, verifier: string, standardAge: number): Promise<UserAgeType>;

    checkUserAge(carrier: CarrierCode, sessionId: string, verifier: string, standardAge: number, callback?: (error: ttypes.TalkException, response: UserAgeType)=>void): void;

    checkUserAgeWithDocomo(openIdRedirectUrl: string, standardAge: number, verifier: string): Promise<AgeCheckDocomoResult>;

    checkUserAgeWithDocomo(openIdRedirectUrl: string, standardAge: number, verifier: string, callback?: (error: ttypes.TalkException, response: AgeCheckDocomoResult)=>void): void;

    retrieveOpenIdAuthUrlWithDocomo(): Promise<string>;

    retrieveOpenIdAuthUrlWithDocomo(callback?: (error: ttypes.TalkException, response: string)=>void): void;

    retrieveRequestToken(carrier: CarrierCode): Promise<AgeCheckRequestResult>;

    retrieveRequestToken(carrier: CarrierCode, callback?: (error: ttypes.TalkException, response: AgeCheckRequestResult)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_checkUserAge(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_checkUserAgeWithDocomo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_retrieveOpenIdAuthUrlWithDocomo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_retrieveRequestToken(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
