...
declare class Client {
    ...
    registerVirtualAccount(locale: string, encryptedVirtualUserId: string, encryptedPassword: string): Promise<string>;

    registerVirtualAccount(locale: string, encryptedVirtualUserId: string, encryptedPassword: string, callback?: (error: ttypes.TalkException, response: string)=>void): void;

    unregisterVirtualAccount(virtualMid: string): Promise<void>;

    unregisterVirtualAccount(virtualMid: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    requestVirtualAccountPasswordChange(virtualMid: string, encryptedVirtualUserId: string, encryptedOldPassword: string, encryptedNewPassword: string): Promise<void>;

    requestVirtualAccountPasswordChange(virtualMid: string, encryptedVirtualUserId: string, encryptedOldPassword: string, encryptedNewPassword: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    notifyEmailConfirmationResult(parameterMap: { [k: string]: string; }): Promise<void>;

    notifyEmailConfirmationResult(parameterMap: { [k: string]: string; }, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    requestVirtualAccountPasswordSet(virtualMid: string, encryptedVirtualUserId: string, encryptedNewPassword: string): Promise<void>;

    requestVirtualAccountPasswordSet(virtualMid: string, encryptedVirtualUserId: string, encryptedNewPassword: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    getRSAKey(): Promise<RSAKey>;

    getRSAKey(callback?: (error: ttypes.TalkException, response: RSAKey)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_registerVirtualAccount(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_unregisterVirtualAccount(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_requestVirtualAccountPasswordChange(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_notifyEmailConfirmationResult(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_requestVirtualAccountPasswordSet(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getRSAKey(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
