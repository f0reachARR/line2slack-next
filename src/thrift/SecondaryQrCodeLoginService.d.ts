...
declare class Client {
    ...
    createSession(): Promise<LoginQrCode_CreateQrSessionResponse>;

    createSession(callback?: (error: ttypes.SecondaryQrCodeException, response: LoginQrCode_CreateQrSessionResponse)=>void): void;

    createQrCode(request: LoginQrCode_CreateQrCodeRequest): Promise<LoginQrCode_CreateQrCodeResponse>;

    createQrCode(request: LoginQrCode_CreateQrCodeRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: LoginQrCode_CreateQrCodeResponse)=>void): void;

    verifyCertificate(request: LoginQrCode_VerifyCertificateRequest): Promise<void>;

    verifyCertificate(request: LoginQrCode_VerifyCertificateRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: void)=>void): void;

    createPinCode(request: LoginQrCode_CreatePinCodeRequest): Promise<LoginQrCode_CreatePinCodeResponse>;

    createPinCode(request: LoginQrCode_CreatePinCodeRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: LoginQrCode_CreatePinCodeResponse)=>void): void;

    qrCodeLogin(request: LoginQrCode_QrCodeLoginRequest): Promise<LoginQrCode_QrCodeLoginResponse>;

    qrCodeLogin(request: LoginQrCode_QrCodeLoginRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: LoginQrCode_QrCodeLoginResponse)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    ...
    process_createQrCode(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_verifyCertificate(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_createPinCode(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_qrCodeLogin(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
