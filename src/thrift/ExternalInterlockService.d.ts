...
declare class Client {
    ...
    getPlaceSearchInfo(provider: PlaceSearchProvider, keyword: string, clientLocale: string, latitude: number, longitude: number, radius: number): Promise<PlaceSearchInfo[]>;

    getPlaceSearchInfo(provider: PlaceSearchProvider, keyword: string, clientLocale: string, latitude: number, longitude: number, radius: number, callback?: (error: ttypes.TalkException, response: PlaceSearchInfo[])=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getPlaceSearchInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
