...
declare class Client {
    ...
    requestBanPageForUser(): Promise<BanPage>;

    requestBanPageForUser(callback?: (error: ttypes.TalkException, response: BanPage)=>void): void;

    requestBanPage(): Promise<BanPage>;

    requestBanPage(callback?: (error: ttypes.TalkException, response: BanPage)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_requestBanPageForUser(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_requestBanPage(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
