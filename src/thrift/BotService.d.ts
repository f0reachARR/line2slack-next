...
declare class Client {
    ...
    notifyLeaveGroup(groupMid: string): Promise<void>;

    notifyLeaveGroup(groupMid: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    notifyLeaveRoom(roomMid: string): Promise<void>;

    notifyLeaveRoom(roomMid: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;

    getBotUseInfo(botMid: string): Promise<BotUseInfo>;

    getBotUseInfo(botMid: string, callback?: (error: ttypes.TalkException, response: BotUseInfo)=>void): void;
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_notifyLeaveGroup(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_notifyLeaveRoom(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBotUseInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
