...
declare class Client {
    ...
    getCoinUseAndRefundHistory(request: GetCoinHistoryRequest): Promise<GetCoinHistoryResponse>;

    getCoinUseAndRefundHistory(request: GetCoinHistoryRequest, callback?: (error: ttypes.TalkException, response: GetCoinHistoryResponse)=>void): void;

    getTotalCoinBalance(request: GetTotalCoinBalanceRequest): Promise<GetTotalCoinBalanceResponse>;

    getTotalCoinBalance(request: GetTotalCoinBalanceRequest, callback?: (error: ttypes.TalkException, response: GetTotalCoinBalanceResponse)=>void): void;

    getCoinProducts(request: GetCoinProductsRequest): Promise<GetCoinProductsResponse>;

    getCoinProducts(request: GetCoinProductsRequest, callback?: (error: ttypes.TalkException, response: GetCoinProductsResponse)=>void): void;

    getCoinPurchaseHistory(request: GetCoinHistoryRequest): Promise<GetCoinHistoryResponse>;

    getCoinPurchaseHistory(request: GetCoinHistoryRequest, callback?: (error: ttypes.TalkException, response: GetCoinHistoryResponse)=>void): void;
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    ...
    process_getTotalCoinBalance(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
