...
declare class Client {
    ...
    queryBeaconActions(hwid: string, secureMessage: string, applicationType: ApplicationType, applicationVersion: string, lang: string): Promise<BeaconQueryResponse>;

    queryBeaconActions(hwid: string, secureMessage: string, applicationType: ApplicationType, applicationVersion: string, lang: string, callback?: (error: ttypes.TalkException, response: BeaconQueryResponse)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_queryBeaconActions(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
