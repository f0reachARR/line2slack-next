...
declare class Client {
    ...
    lookupByPhoneNumber(countryAreaCode: string, phoneNumber: string): Promise<SpotPhoneNumberResponse>;

    lookupByPhoneNumber(countryAreaCode: string, phoneNumber: string, callback?: (error: ttypes.TalkException, response: SpotPhoneNumberResponse)=>void): void;

    lookupNearby(location: Location, category: SpotCategory, query: string, countryAreaCode: string): Promise<SpotNearbyResponse>;

    lookupNearby(location: Location, category: SpotCategory, query: string, countryAreaCode: string, callback?: (error: ttypes.TalkException, response: SpotNearbyResponse)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_lookupByPhoneNumber(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_lookupNearby(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
