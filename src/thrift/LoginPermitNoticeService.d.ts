...
declare class Client {
    ...
    checkQrCodeVerified(request: LoginQrCode_CheckQrCodeVerifiedRequest): Promise<void>;

    checkQrCodeVerified(request: LoginQrCode_CheckQrCodeVerifiedRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: void)=>void): void;

    checkPinCodeVerified(request: LoginQrCode_CheckPinCodeVerifiedRequest): Promise<void>;

    checkPinCodeVerified(request: LoginQrCode_CheckPinCodeVerifiedRequest, callback?: (error: ttypes.SecondaryQrCodeException, response: void)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_checkQrCodeVerified(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_checkPinCodeVerified(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
