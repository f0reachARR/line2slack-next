...
declare class Client {
    ...
    getBuddyStatusBar(buddyMid: string, revision: Int64): Promise<BuddyStatusBar>;

    getBuddyStatusBar(buddyMid: string, revision: Int64, callback?: (error: ttypes.TalkException, response: BuddyStatusBar)=>void): void;

    getRichMenuContents(buddyMid: string, revision: Int64): Promise<BuddyRichMenuContents>;

    getRichMenuContents(buddyMid: string, revision: Int64, callback?: (error: ttypes.TalkException, response: BuddyRichMenuContents)=>void): void;

    getBuddyProfilePopup(buddyMid: string): Promise<BuddyProfilePopup>;

    getBuddyProfilePopup(buddyMid: string, callback?: (error: ttypes.TalkException, response: BuddyProfilePopup)=>void): void;

    getPopularBuddyBanner(language: string, country: string, applicationType: ApplicationType, resourceSpecification: string): Promise<BuddyBanner>;

    getPopularBuddyBanner(language: string, country: string, applicationType: ApplicationType, resourceSpecification: string, callback?: (error: ttypes.TalkException, response: BuddyBanner)=>void): void;

    getPopularBuddyLists(language: string, country: string): Promise<BuddyList[]>;

    getPopularBuddyLists(language: string, country: string, callback?: (error: ttypes.TalkException, response: BuddyList[])=>void): void;

    findBuddyContactsByQuery(language: string, country: string, query: string, fromIndex: number, count: number, requestSource: BuddySearchRequestSource): Promise<BuddySearchResult[]>;

    findBuddyContactsByQuery(language: string, country: string, query: string, fromIndex: number, count: number, requestSource: BuddySearchRequestSource, callback?: (error: ttypes.TalkException, response: BuddySearchResult[])=>void): void;

    getBuddyNewsView(language: string, country: string, offset: Int64, limit: number): Promise<BuddyNewsView>;

    getBuddyNewsView(language: string, country: string, offset: Int64, limit: number, callback?: (error: ttypes.TalkException, response: BuddyNewsView)=>void): void;

    getBuddyContacts(language: string, country: string, classification: string, fromIndex: number, count: number): Promise<Contact[]>;

    getBuddyContacts(language: string, country: string, classification: string, fromIndex: number, count: number, callback?: (error: ttypes.TalkException, response: Contact[])=>void): void;

    getBuddyCollectionEntries(language: string, country: string, collection: number, offset: number, limit: number): Promise<BuddyCollectionEntry[]>;

    getBuddyCollectionEntries(language: string, country: string, collection: number, offset: number, limit: number, callback?: (error: ttypes.TalkException, response: BuddyCollectionEntry[])=>void): void;

    getLatestBuddyNewsTimestamp(country: string): Promise<Int64>;

    getLatestBuddyNewsTimestamp(country: string, callback?: (error: ttypes.TalkException, response: Int64)=>void): void;

    getBuddyChatBar(buddyMid: string, revision: Int64): Promise<BuddyChatBar>;

    getBuddyChatBar(buddyMid: string, revision: Int64, callback?: (error: ttypes.TalkException, response: BuddyChatBar)=>void): void;

    getCountriesServingOfficialAccountPromotionV2(): Promise<string[]>;

    getCountriesServingOfficialAccountPromotionV2(callback?: (error: ttypes.TalkException, response: string[])=>void): void;

    getBuddyDetail(buddyMid: string): Promise<BuddyDetail>;

    getBuddyDetail(buddyMid: string, callback?: (error: ttypes.TalkException, response: BuddyDetail)=>void): void;

    getBuddyOnAir(buddyMid: string): Promise<BuddyOnAir>;

    getBuddyOnAir(buddyMid: string, callback?: (error: ttypes.TalkException, response: BuddyOnAir)=>void): void;

    getNewlyReleasedBuddyIds(country: string): Promise<{ [k: string]: Int64; }>;

    getNewlyReleasedBuddyIds(country: string, callback?: (error: ttypes.TalkException, response: { [k: string]: Int64; })=>void): void;

    getBuddyCategoryView(language: string, country: string): Promise<BuddyCategoryView>;

    getBuddyCategoryView(language: string, country: string, callback?: (error: ttypes.TalkException, response: BuddyCategoryView)=>void): void;

    getCountriesHavingBuddy(): Promise<string[]>;

    getCountriesHavingBuddy(callback?: (error: ttypes.TalkException, response: string[])=>void): void;

    getPromotedBuddyContacts(language: string, country: string): Promise<Contact[]>;

    getPromotedBuddyContacts(language: string, country: string, callback?: (error: ttypes.TalkException, response: Contact[])=>void): void;

    getBuddyTopView(language: string, country: string): Promise<BuddyTopView>;

    getBuddyTopView(language: string, country: string, callback?: (error: ttypes.TalkException, response: BuddyTopView)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyStatusBar(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getRichMenuContents(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyProfilePopup(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getPopularBuddyBanner(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getPopularBuddyLists(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_findBuddyContactsByQuery(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyNewsView(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyContacts(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyCollectionEntries(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getLatestBuddyNewsTimestamp(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyChatBar(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getCountriesServingOfficialAccountPromotionV2(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyDetail(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyOnAir(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getNewlyReleasedBuddyIds(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyCategoryView(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getCountriesHavingBuddy(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getPromotedBuddyContacts(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getBuddyTopView(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
