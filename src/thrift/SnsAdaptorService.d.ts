...
declare class Client {
    ...
    getSnsFriends(snsIdType: SnsIdType, snsAccessToken: string, startIdx: number, limit: number): Promise<SnsFriends>;

    getSnsFriends(snsIdType: SnsIdType, snsAccessToken: string, startIdx: number, limit: number, callback?: (error: ttypes.TalkException, response: SnsFriends)=>void): void;

    getSnsMyProfile(snsIdType: SnsIdType, snsAccessToken: string): Promise<SnsProfile>;

    getSnsMyProfile(snsIdType: SnsIdType, snsAccessToken: string, callback?: (error: ttypes.TalkException, response: SnsProfile)=>void): void;

    postSnsInvitationMessage(snsIdType: SnsIdType, snsAccessToken: string, toSnsUserId: string): Promise<void>;

    postSnsInvitationMessage(snsIdType: SnsIdType, snsAccessToken: string, toSnsUserId: string, callback?: (error: ttypes.TalkException, response: void)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getSnsFriends(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getSnsMyProfile(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_postSnsInvitationMessage(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
