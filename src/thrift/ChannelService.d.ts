...
declare class Client {
    ...
    getDomains(lastSynced: Int64): Promise<ChannelDomains>;

    getDomains(lastSynced: Int64, callback?: (error: ttypes.ChannelException, response: ChannelDomains)=>void): void;

    approveChannelAndIssueRequestToken(channelId: string, otpId: string): Promise<string>;

    approveChannelAndIssueRequestToken(channelId: string, otpId: string, callback?: (error: ttypes.ChannelException, response: string)=>void): void;

    issueOTP(channelId: string): Promise<OTPResult>;

    issueOTP(channelId: string, callback?: (error: ttypes.ChannelException, response: OTPResult)=>void): void;

    getChannelSettings(): Promise<ChannelSettings>;

    getChannelSettings(callback?: (error: ttypes.ChannelException, response: ChannelSettings)=>void): void;

    getChannelNotificationSettings(locale: string): Promise<ChannelNotificationSetting[]>;

    getChannelNotificationSettings(locale: string, callback?: (error: ttypes.ChannelException, response: ChannelNotificationSetting[])=>void): void;

    updateChannelNotificationSetting(setting: ChannelNotificationSetting[]): Promise<void>;

    updateChannelNotificationSetting(setting: ChannelNotificationSetting[], callback?: (error: ttypes.ChannelException, response: void)=>void): void;

    updateChannelSettings(channelSettings: ChannelSettings): Promise<boolean>;

    updateChannelSettings(channelSettings: ChannelSettings, callback?: (error: ttypes.ChannelException, response: boolean)=>void): void;

    getCommonDomains(lastSynced: Int64): Promise<ChannelDomains>;

    getCommonDomains(lastSynced: Int64, callback?: (error: ttypes.ChannelException, response: ChannelDomains)=>void): void;

    issueRequestTokenWithAuthScheme(channelId: string, otpId: string, authScheme: string[], returnUrl: string): Promise<RequestTokenResponse>;

    issueRequestTokenWithAuthScheme(channelId: string, otpId: string, authScheme: string[], returnUrl: string, callback?: (error: ttypes.ChannelException, response: RequestTokenResponse)=>void): void;

    getChannelNotificationSetting(channelId: string, locale: string): Promise<ChannelNotificationSetting>;

    getChannelNotificationSetting(channelId: string, locale: string, callback?: (error: ttypes.ChannelException, response: ChannelNotificationSetting)=>void): void;

    issueChannelToken(channelId: string): Promise<ChannelToken>;

    issueChannelToken(channelId: string, callback?: (error: ttypes.ChannelException, response: ChannelToken)=>void): void;

    getChannels(lastSynced: Int64, locale: string): Promise<ChannelInfos>;

    getChannels(lastSynced: Int64, locale: string, callback?: (error: ttypes.ChannelException, response: ChannelInfos)=>void): void;

    fetchNotificationItems(localRev: Int64): Promise<NotificationFetchResult>;

    fetchNotificationItems(localRev: Int64, callback?: (error: ttypes.ChannelException, response: NotificationFetchResult)=>void): void;

    getChannelInfo(channelId: string, locale: string): Promise<ChannelInfo>;

    getChannelInfo(channelId: string, locale: string, callback?: (error: ttypes.ChannelException, response: ChannelInfo)=>void): void;

    getNotificationBadgeCount(localRev: Int64): Promise<number>;

    getNotificationBadgeCount(localRev: Int64, callback?: (error: ttypes.ChannelException, response: number)=>void): void;

    issueRequestToken(channelId: string, otpId: string): Promise<string>;

    issueRequestToken(channelId: string, otpId: string, callback?: (error: ttypes.ChannelException, response: string)=>void): void;

    revokeChannel(channelId: string): Promise<void>;

    revokeChannel(channelId: string, callback?: (error: ttypes.ChannelException, response: void)=>void): void;

    getApprovedChannels(lastSynced: Int64, locale: string): Promise<ApprovedChannelInfos>;

    getApprovedChannels(lastSynced: Int64, locale: string, callback?: (error: ttypes.ChannelException, response: ApprovedChannelInfos)=>void): void;

    getFriendChannelMatrices(channelIds: string[]): Promise<FriendChannelMatricesResponse>;

    getFriendChannelMatrices(channelIds: string[], callback?: (error: ttypes.ChannelException, response: FriendChannelMatricesResponse)=>void): void;

    issueRequestTokenForAutoLogin(channelId: string, otpId: string, redirectUrl: string): Promise<string>;

    issueRequestTokenForAutoLogin(channelId: string, otpId: string, redirectUrl: string, callback?: (error: ttypes.ChannelException, response: string)=>void): void;

    getUpdatedChannelIds(channelIds: ChannelIdWithLastUpdated[]): Promise<string[]>;

    getUpdatedChannelIds(channelIds: ChannelIdWithLastUpdated[], callback?: (error: ttypes.ChannelException, response: string[])=>void): void;

    reserveCoinUse(request: CoinUseReservation, locale: string): Promise<string>;

    reserveCoinUse(request: CoinUseReservation, locale: string, callback?: (error: ttypes.ChannelException, response: string)=>void): void;

    syncChannelData(lastSynced: Int64, locale: string): Promise<ChannelSyncDatas>;

    syncChannelData(lastSynced: Int64, locale: string, callback?: (error: ttypes.ChannelException, response: ChannelSyncDatas)=>void): void;

    approveChannelAndIssueChannelToken(channelId: string): Promise<ChannelToken>;

    approveChannelAndIssueChannelToken(channelId: string, callback?: (error: ttypes.ChannelException, response: ChannelToken)=>void): void;
  }
...
declare class Processor {
  ...
  process(input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getDomains(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_approveChannelAndIssueRequestToken(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_issueOTP(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getChannelSettings(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getChannelNotificationSettings(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_updateChannelNotificationSetting(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_updateChannelSettings(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getCommonDomains(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_issueRequestTokenWithAuthScheme(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getChannelNotificationSetting(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_issueChannelToken(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getChannels(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_fetchNotificationItems(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getChannelInfo(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getNotificationBadgeCount(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_issueRequestToken(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_revokeChannel(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getApprovedChannels(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getFriendChannelMatrices(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_issueRequestTokenForAutoLogin(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_getUpdatedChannelIds(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_reserveCoinUse(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_syncChannelData(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
    process_approveChannelAndIssueChannelToken(seqid: number, input: thrift.TProtocol, output: thrift.TProtocol): void;
}
